...
import com.elo7.marte.domain.planalto.PlanaltoRequeridoException;
import com.elo7.marte.domain.planalto.PossivelColisaoSondasNoPlanaltoException;
import com.elo7.marte.domain.planalto.SondaNoPlanalto;
import com.elo7.marte.domain.registro_bordo.StatusMovimentacaoSonda;
...
public class Sonda{
	...
	public void iniciarExploracao(final List<Comando> comandos, final Set<PosicaoDirecional> posicoesOcupadasOutrasSondas) throws CoordenadaForaDoPlanaltoException, PossivelColisaoSondasNoPlanaltoException {
		...
		for (Comando comando : comandos) {
			...
			gravarRegistroBordo(sondaNoPlanalto, comando, indice == comandos.size());
		}
	}

	private void gravarRegistroBordo(SondaNoPlanalto sondaNoPlanalto, Comando comando, boolean isUltimoComando) {
		StatusMovimentacaoSonda statusDaMovimentacao = isUltimoComando ? StatusMovimentacaoSonda.POSICAO_FINAL : StatusMovimentacaoSonda.EM_MOVIMENTO;
		sondaNoPlanalto.gravarRegistroBordo(comando,posicaoAtual,statusDaMovimentacao);
	}
