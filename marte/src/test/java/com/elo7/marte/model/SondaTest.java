...
public class SondaTest {
	...
	public void deveConsiderarDuasSondasIguais(){
		Sonda sonda1 = new Sonda(PosicaoAtual.builder().naCoordenada(new Coordenada(3,3)).naDirecao(Direcao.E).build(), new Planalto(5, 5));
		Sonda sonda2 = new Sonda(PosicaoAtual.builder().naCoordenada(new Coordenada(3,3)).naDirecao(Direcao.E).build(), new Planalto(5, 5));
	...
	public void deveConsiderarDuasSondasDiferentesPelaPosicao(){
		Sonda sonda1 = new Sonda(PosicaoAtual.builder().naCoordenada(new Coordenada(1,3)).naDirecao(Direcao.E).build(), new Planalto(5, 5));
		Sonda sonda2 = new Sonda(PosicaoAtual.builder().naCoordenada(new Coordenada(3,1)).naDirecao(Direcao.E).build(), new Planalto(5, 5));
	...
	public void deveConsiderarDuasSondasDiferentesPelaDirecaoInicial(){
		Sonda sonda1 = new Sonda(PosicaoAtual.builder().naCoordenada(new Coordenada(1,3)).naDirecao(Direcao.E).build(), new Planalto(5, 5));
		Sonda sonda2 = new Sonda(PosicaoAtual.builder().naCoordenada(new Coordenada(3,1)).naDirecao(Direcao.W).build(), new Planalto(5, 5));
	...
	public void deveConsiderarDuasSondasDiferentesPelaPlanalto(){
		Sonda sonda1 = new Sonda(PosicaoAtual.builder().naCoordenada(new Coordenada(1,3)).naDirecao(Direcao.E).build(), new Planalto(5, 1));
		Sonda sonda2 = new Sonda(PosicaoAtual.builder().naCoordenada(new Coordenada(3,1)).naDirecao(Direcao.W).build(), new Planalto(1, 5));
	...
	public void deveLancarExcecaoPlanaltoNulo(){
		new Sonda(PosicaoAtual.builder().naCoordenada(new Coordenada(1,3)).naDirecao(Direcao.E).build(), null);
	}
	...
	public void deveExecucaoComandosParandoComLancamentoDeComandoInvalidoException() throws CoordenadaInvalidaException{
		...
		try{
			...
			sonda = new Sonda(PosicaoAtual.builder().naCoordenada(new Coordenada(1, 2)).naDirecao(Direcao.N).build(), new Planalto(5, 5));
			sonda.iniciarExploracao(comandos);
			fail();
	...
	public void deveExecucaoComandosParandoComLancamentoDeCoordenadaInvalidaException() throws ComandoInvalidoException{
		...
		try{
			List<Comando> comandos = Arrays.asList(Comando.L, Comando.M, Comando.L, Comando.M, Comando.L, Comando.M, Comando.L, Comando.M, Comando.M);
			sonda = new Sonda(PosicaoAtual.builder().naCoordenada(new Coordenada(1, 2)).naDirecao(Direcao.N).build(), new Planalto(1, 2));
			sonda.iniciarExploracao(comandos);
			fail();
